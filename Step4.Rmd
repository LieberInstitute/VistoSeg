...
4. **Select Scale Factors JSON File** : Select the [scalefactors_json.json](https://github.com/LieberInstitute/VisiumLIBD/blob/main/pipeline_outputs/spaceranger/scalefactors_json.json) file with the visium spot metrics obtained from the **Spaceranger** software.
<center>
...
<img src="images/zoom in 2.png" title="Color cluster 1" width="300"/> <img src="images/zoom in 2 BW.png" title="Indexed object 1" width="300"/> 
